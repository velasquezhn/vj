...
add_many("BLOQUE 16 — WhatsApp huésped", "Huésped", "WhatsApp huésped", [
    ...
    ("mostrar las siete opciones", "Pulse Ver opciones", "Aparecen Alojamientos, Reservar ahora, Experiencias, Contacto, Clima, Preguntas frecuentes y Mi reserva."),
    ...
    ("reiniciar un flujo", "Entre a Reserva, Clima, Alojamientos y Experiencias|Escriba reiniciar en recorridos separados", "Cada flujo vuelve a su primer paso seguro sin mezclar datos anteriores."),
    ("solicitar ayuda global", "Desde un submenú escriba ayuda", "Avisa a los administradores activos y confirma la entrega sin bloquear el regreso al menú."),
    ("rechazar opción inexistente", "En el menú escriba 99 o texto desconocido", "Explica cómo usar botones o números 1 a 7 y vuelve a mostrar las opciones."),
    ...
    ("mostrar contacto", "Seleccione Contacto", "Permite escribir una consulta, solicitar ayuda o volver al menú."),
    ("enviar consulta de contacto", "Seleccione Contacto|Escriba una consulta menor de 300 caracteres", "Avisa una sola vez a los administradores y confirma que uno responderá por privado."),
    ("rechazar consulta de contacto extensa", "Seleccione Contacto|Envíe más de 300 caracteres", "Solicita resumir el mensaje y conserva las opciones Ayuda y Menú principal."),
    ("consultar clima exclusivo de Tela", "Seleccione Clima", "Consulta Tela inmediatamente sin solicitar otra ciudad y muestra Actualizar y Menú principal."),
    ("ignorar otra ubicación en clima", "Dentro de Clima escriba La Ceiba, Honduras", "Mantiene la consulta exclusiva de Tela sin cambiar la ubicación."),
    ("rechazar ciudad inválida", "Escriba 123 o un único carácter", "Explica el formato sin consultar al proveedor y conserva las acciones de recuperación."),
...
add_many("BLOQUE 17 — Reserva y aprobación WhatsApp", "Huésped", "WhatsApp huésped", [
    ...
    ("validar nombre del huésped", "Envíe un carácter o solo números|Luego envíe Huésped QA", "Rechaza el nombre inválido y acepta el nombre completo."),
    ("validar cantidad de huéspedes", "Pruebe 0, texto, 4abc y una cantidad mayor de 9|Luego envíe 2", "Rechaza valores inválidos y acepta una cantidad permitida."),
    ...
    ("cancelar con confirmación explícita", "Desde Mi reserva solicite Cancelar reserva|Pulse Sí, cancelar", "Informa que no hay reembolso, cancela el registro sin borrarlo y notifica al huésped y a los administradores."),
...
add_many("BLOQUE 19 — Webhook e integraciones", "Superadministrador + técnico QA", "Webhook Meta", [
    ...
    ("manejar clima no configurado", "Desactive OPENWEATHER_API_KEY y ALLOW_FREE_WEATHER_FALLBACK|Seleccione Clima", "El bot informa la configuración faltante y ofrece actualizar Tela o volver al menú."),
...
add_many("BLOQUE 19 — Webhook e integraciones", "Superadministrador + técnico QA", "Seguridad", [
    ("responder health y readiness", "Consulte /health y /ready", "Health responde ok; Ready confirma database ok y estados de WhatsApp y clima sin exponer secretos.", {"technical": True}),
