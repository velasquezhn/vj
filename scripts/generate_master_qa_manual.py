...
add_many("BLOQUE 16 — WhatsApp huésped", "Huésped", "WhatsApp huésped", [
    ...
    ("solicitar ciudad para el clima", "Seleccione Clima", "Solicita una ciudad, ofrece Tela y permite volver al menú."),
    ("consultar clima por texto", "Escriba La Ceiba, Honduras", "Muestra condiciones actuales y de mañana con acciones Actualizar, Otra ciudad y Menú principal."),
    ...
    ("consultar otra ciudad", "Después del resultado pulse Otra ciudad|Escriba San Pedro Sula, Honduras", "Procesa la nueva ciudad sin mezclarla con la consulta anterior."),
