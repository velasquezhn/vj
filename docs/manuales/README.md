...
Documentación elaborada y actualizada a partir del backend, el panel administrativo, los flujos de WhatsApp y las verificaciones del ambiente QA realizadas al 5 de septiembre de 2026.
...
- `07_Manual_Maestro_QA_UAT_Villas_Julie.docx`: plan ejecutable con 286 pruebas consecutivas, inventario de cobertura, permisos positivos y negativos, registro de bugs, regresión y decisión final de producción.
